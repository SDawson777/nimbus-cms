...
const NavigationItems = [
  ...
  {group:'Content', label:'Articles', href:'/content/articles', icon: Document},
  {group:'Content', label:'Deals', href:'/content/deals', icon: Document},
  {group:'Content', label:'Legal Docs', href:'/content/legal', icon: Document},
  {group:'Tenants', label:'Tenant Manager', href:'/tenants', icon: Users},
  {group:'Analytics', label:'Sales', href:'/analytics/sales', icon: Chart},
  {group:'Analytics', label:'Traffic', href:'/analytics/traffic', icon: Chart},
  {group:'Analytics', label:'Engagement', href:'/analytics/engagement', icon: Chart},
