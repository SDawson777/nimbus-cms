...
async function main() {
  ...
  const inventoryCombos = [
    {store: detroit, productId: 'prod-nimbus-og-35', inventory: 120, price: 35},
    {store: detroit, productId: 'prod-midnight-mints', inventory: 80, price: 18},
    {store: detroit, productId: 'prod-sunrise-sativa', inventory: 60, price: 12},
    {store: scottsdale, productId: 'prod-limonene-live-resin', inventory: 40, price: 55},
    {store: scottsdale, productId: 'prod-glass-510-battery', inventory: 30, price: 30},
    {store: boulder, productId: 'prod-calm-cbd-tincture', inventory: 50, price: 45},
    ...
    data: [
      {
        userId: demoUser.id,
        mood: 'relaxed',
        notes: 'Nimbus OG helped me wind down after work without being couch-locked.',
      },
      {
        userId: demoUser.id,
        mood: 'sleepy',
