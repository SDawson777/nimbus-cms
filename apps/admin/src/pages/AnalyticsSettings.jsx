...
export default function AnalyticsSettings() {
  ...
  function validate(s) {
    ...
    if (s.recentDays > s.windowDays)
      errors.recentDays = "Recent days cannot exceed window";
    if (!Number.isFinite(s.wRecentClicks))
      errors.wRecentClicks = "Must be a number";
    if (!Number.isFinite(s.wRecentViews))
      errors.wRecentViews = "Must be a number";
    if (!Number.isFinite(s.wHistoricClicks))
      errors.wHistoricClicks = "Must be a number";
    if (!Number.isFinite(s.wHistoricViews))
      errors.wHistoricViews = "Must be a number";
    ...
    <div style={{ padding: 20 }}>
      ...
      <div style={{ maxWidth: 640 }}>
        <label>
          ...
          />
          {errors.windowDays && (
            <div style={{ color: "red" }}>{errors.windowDays}</div>
          )}
        </label>
        <br />
        <label>
          ...
          />
          {errors.recentDays && (
            <div style={{ color: "red" }}>{errors.recentDays}</div>
          )}
        </label>
        <hr />
        <label>
          ...
          <input
            ...
            onChange={(e) =>
              updateField("wRecentClicks", Number(e.target.value))
            }
          />
        </label>
        <br />
        <label>
          ...
          <input
            ...
            onChange={(e) =>
              updateField("wRecentViews", Number(e.target.value))
            }
          />
        </label>
        <br />
        <label>
          ...
          <input
            ...
            onChange={(e) =>
              updateField("wHistoricClicks", Number(e.target.value))
            }
          />
        </label>
        <br />
        <label>
          ...
          <input
            ...
            onChange={(e) =>
              updateField("wHistoricViews", Number(e.target.value))
            }
          />
        </label>
        <hr />
        <label>
          ...
          <input
            ...
            onChange={(e) =>
              updateField("thresholdRising", Number(e.target.value))
            }
          />
        </label>
        <br />
        <label>
          ...
          <input
            ...
            onChange={(e) =>
              updateField("thresholdSteady", Number(e.target.value))
            }
          />
        </label>
        <br />
        <label>
          ...
          <input
            ...
            onChange={(e) =>
              updateField("thresholdFalling", Number(e.target.value))
            }
          />
        </label>
