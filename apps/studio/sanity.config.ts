...
const projectId = process.env.SANITY_PROJECT_ID || process.env.SANITY_STUDIO_PROJECT_ID || 'ygbu28p2'
const dataset = process.env.SANITY_DATASET || process.env.SANITY_STUDIO_DATASET || 'nimbus_demo'
